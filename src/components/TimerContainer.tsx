...
export const TimerContainer: React.FC<TimerContainerProps> = ({
    ...
    return (
        <div className="flex flex-col w-full App bg-[#282c34] text-white text-[calc(10px+2vmin)] overflow-hidden"
             style={{
                 height: '100%'
             }}>
            ...
            <div className="flex-col w-full flex flex-1" style={{height: 10}}>
                ...
                <div className="w-full" style={{height: 100}}>
                    <Button
                        ...
                        className={`w-[85%]  mt-6 rounded-lg ${buttonColor}`}
                        name="초기화"
                        fontSize="text-[25px]"
                    />
                </div>
